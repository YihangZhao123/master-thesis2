    ...
    String _xblockexpression = null;
    {
      ...
      _builder.newLine();
      {
        ...
        for(final Vertex sdf_2 : sdfCombSet) {
          ...
          String _name_7 = Name.name(sdf_2);
      ...
      }
      {
        ...
        for(final Vertex sdf_3 : sdfCombSet) {
          ...
          String _name_8 = Name.name(sdf_3);
      ...
      _builder.newLine();
      {
        ...
        for(final Vertex sdf_4 : sdfCombSet) {
          ...
          String _name_9 = Name.name(sdf_4);
      ...
      _builder.newLine();
      {
        ...
        for(final Vertex sdf_5 : sdfCombSet) {
          ...
          String _name_13 = Name.name(sdf_5);
      ...
      _builder.newLine();
      {
        ...
        for(final Vertex sdf_6 : sdfCombSet) {
          ...
          String _name_17 = Name.name(sdf_6);
